...
<body>
    ...
    <?php
                    ...
                    if(!$con) {
                      ...
                      $dayAfterTomorrowDate=$datetime->format('d');
                      $dayAfterTomorrowDateMonth=$datetime->format('m');

                      echo $dayAfterTomorrowDate." ".$dayAfterTomorrowDateMonth;

                      $query = "SELECT * FROM userdetails where  month(DOB)='$dayAfterTomorrowDateMonth' and day(DOB)='$dayAfterTomorrowDate' ORDER BY `userdetails`.`DOB` DESC";
