...
<body>
    ...
    <?php
                    ...
                    if(!$con) {
                      ...
                      $tomorrowDate=$datetime->format('d');
                      $tomorrowDateMonth=$datetime->format('m');
                      echo $tomorrowDate."  ".$tomorrowDateMonth;
                      $query = "SELECT * FROM userdetails where  month(DOB)='$tomorrowDateMonth' and day(DOB)='$tomorrowDate' ORDER BY `userdetails`.`DOB` DESC";

                      
                    $results = mysqli_query($con,$query);
                    
                    if(mysqli_num_rows($results)==0){
                        $msg = "No Birthdays Tomorrow";
                    }
