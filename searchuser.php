...
<body>
    <div class="container">
        <form name="frmSearch" method="post" action="#">
            <div class="form-group">
                <label style="font-weight: bold" for="ItemName">Name:</label>
                <input type="text" class="form-control" id="name" placeholder="Enter First Name" name="name" required
                    onkeyup="startTime()" onkeydown="endTime()">
            </div>


        </form>
        <a href="viewuser.php" class="btn btn-info" role="button">Refresh</a>&nbsp;&nbsp;&nbsp; <a href="adduser.html"
            class="btn btn-success" role="button">Add a New User!!!!</a>
    </div>
    ...
    <?php
                    ...
                    if(isset($_POST['name'])){
                        ...
                        $searchName = str_replace(' ', '', $_POST['name']);
                    ...
                    if(!$con) {
                      ...
                      $query ="SELECT * FROM userdetails where  fname like '%$searchName%'";
